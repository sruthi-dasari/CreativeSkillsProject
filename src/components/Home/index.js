        ...
        <>
            <div className='home-container'>
                ...
                <div className='main-container'>
                    ...
                    <h1 className='home-heading'>CLASSPASS</h1>
                    <p className='home-para center-aligned-para'>
                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.
                        Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis,
                        ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo,
                        fringilla vel, aliquet nec, vulputate
                    </p>
                    <h1 className='home-heading'>WE WORKED TOGETHER ON</h1>
                    <p className='home-para'>A campaign to text to go here</p>
                    ...
                    <h1 className='home-heading'>THE CHALLENGE</h1>
                    <p className='home-para center-aligned-para'>
                    ...
                    <h1 className='home-heading'>THE RESULTS</h1>
                    ...
                    <p className='home-para center-aligned-para'>"R just knocked it out of the park. They conceptualised brilliant campaigns
